...
class _AddItemSheetState extends ConsumerState<AddItemSheet> {
  ...
  Future<void> _submit() async {
    ...
    if (name.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(l.enterProductName)));
      return;
    }
    final amount = double.tryParse(_amountController.text);
    if (amount == null || amount <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(l.enterValidQuantity)));
      return;
    }
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(labelText: l.productName, border: const OutlineInputBorder(), prefixIcon: const Icon(Icons.fastfood_outlined)),
            ...
            Row(children: [
              Expanded(flex: 2, child: TextField(
                ...
                decoration: InputDecoration(labelText: l.quantity, border: const OutlineInputBorder()),
              )),
            ...
            if (_selectedLocation == 'Other') ...[
              ...
              TextField(
                ...
                decoration: InputDecoration(labelText: l.enterStorageLocation, border: const OutlineInputBorder(), prefixIcon: const Icon(Icons.edit_outlined)),
                textCapitalization: TextCapitalization.sentences,
                autofocus: true,
              ),
            ],
            ...
            TextField(
              ...
              decoration: InputDecoration(labelText: l.notes, border: const OutlineInputBorder(), prefixIcon: const Icon(Icons.notes_outlined)),
              maxLines: 2,
            ),
